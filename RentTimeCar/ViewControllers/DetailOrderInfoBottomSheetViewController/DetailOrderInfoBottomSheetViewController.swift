...
final class DetailOrderInfoBottomSheetViewController: UIViewController {
    ...
    private func setupView() {
        ...
        case .child:
            text = "Автомобиль будет оборудован детскими креслами в соответствии с Вашими запросами"
        case .additionalDriver:
            text = "Если управлять автомобилем планируете не только ВЫ, то каждого дополнительного водителя нужно будет указать в договоре"
        case .unowned:
