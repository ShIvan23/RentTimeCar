...
protocol IRentApiFacade {
    ...
    func payAccruals(clientIntegrationId: String, contractId: Int, sum: Decimal, externalSource: String?, externalSourceTransactionCode: String?, completion: @escaping (Result<ApiResult<EmptyResponse>, Error>) -> Void)
...
final class RentApiFacade: IRentApiFacade {
    ...
    func payAccruals(clientIntegrationId: String, contractId: Int, sum: Decimal, externalSource: String?, externalSourceTransactionCode: String?, completion: @escaping (Result<ApiResult<EmptyResponse>, Error>) -> Void) {
        guard let request = requestManager.payAccruals(
